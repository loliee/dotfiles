...
# sudo cp $HOME/.dotfiles/.media/wallpapers/* /Library/Desktop\ Pictures/
# osascript -e 'tell application "Finder" to set desktop picture to POSIX file "/Library/Desktop Pictures/Calvin and Hobbes 2.jpg"'

# Set my avatar
# sudo dscl . delete $HOME jpegphoto
# sudo cp $HOME/.dotfiles/.media/avatars/*.tif /Library/User\ Pictures/
# sudo dscl . create $HOME Picture '/Library/User Pictures/Charantaise.tif'
